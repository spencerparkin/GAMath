...
public:
	...
	void DrawLine(const HappyMath::Vector3& locationA, const HappyMath::Vector3& locationB, const HappyMath::Vector4& color, bool lit);
	void DrawPlane(const HappyMath::Vector3& center, const HappyMath::Vector3& normal, double radius, const HappyMath::Vector4& color, bool lit);
...
protected:
	...
	void SetupLighting(const HappyMath::Vector4& color, bool lit);
