...
void Multivector::ToSquareMatrix(std::function<void(int, int, double)> elementCallback) const
{
	...
	elementCallback(9, 14, (-1.0)*this->e2_ni);
	elementCallback(9, 13, (-1.0)*this->e2_no);
	elementCallback(9, 15, this->e2_no_ni);
	elementCallback(9, 11, this->ni);
	elementCallback(9, 10, this->no);
	elementCallback(9, 12, this->no_ni);
	elementCallback(9, 2, this->e1);
	elementCallback(9, 1, (-1.0)*this->e1_e2);
	elementCallback(9, 7, (-1.0)*this->e1_e2_ni);
	elementCallback(9, 6, (-1.0)*this->e1_e2_no);
	elementCallback(9, 8, (-1.0)*this->e1_e2_no_ni);
	elementCallback(9, 4, (-1.0)*this->e1_ni);
	elementCallback(9, 3, (-1.0)*this->e1_no);
	elementCallback(9, 5, this->e1_no_ni);
	elementCallback(9, 0, this->e2);
	elementCallback(13, 13, this->_1);
	elementCallback(13, 12, this->e2_ni);
	elementCallback(13, 9, (-1.0)*this->e2_ni);
	elementCallback(13, 10, this->e2_no_ni);
	elementCallback(13, 0, this->ni);
	elementCallback(13, 15, (-1.0)*this->ni);
	elementCallback(13, 13, this->no_ni);
	elementCallback(13, 6, this->e1);
	elementCallback(13, 3, (-1.0)*this->e1_e2);
	elementCallback(13, 2, (-1.0)*this->e1_e2_ni);
	elementCallback(13, 5, this->e1_e2_ni);
	elementCallback(13, 3, (-1.0)*this->e1_e2_no_ni);
	elementCallback(13, 1, (-1.0)*this->e1_ni);
	elementCallback(13, 8, this->e1_ni);
	elementCallback(13, 6, this->e1_no_ni);
	elementCallback(13, 10, this->e2);
	elementCallback(14, 14, this->_1);
	elementCallback(14, 12, (-1.0)*this->e2_no);
	elementCallback(14, 9, (-1.0)*this->e2_no);
	elementCallback(14, 11, (-1.0)*this->e2_no_ni);
	elementCallback(14, 0, this->no);
	elementCallback(14, 15, this->no);
	elementCallback(14, 14, (-1.0)*this->no_ni);
	elementCallback(14, 7, this->e1);
	elementCallback(14, 4, (-1.0)*this->e1_e2);
	elementCallback(14, 2, (-1.0)*this->e1_e2_no);
	elementCallback(14, 5, (-1.0)*this->e1_e2_no);
	elementCallback(14, 4, this->e1_e2_no_ni);
	elementCallback(14, 1, (-1.0)*this->e1_no);
	elementCallback(14, 8, (-1.0)*this->e1_no);
	elementCallback(14, 7, (-1.0)*this->e1_no_ni);
	elementCallback(14, 11, this->e2);
	elementCallback(2, 2, this->_1);
	elementCallback(2, 7, (-1.0)*this->e2_ni);
	elementCallback(2, 6, (-1.0)*this->e2_no);
	elementCallback(2, 8, (-1.0)*this->e2_no_ni);
	elementCallback(2, 4, (-1.0)*this->ni);
	elementCallback(2, 3, (-1.0)*this->no);
	elementCallback(2, 5, this->no_ni);
	elementCallback(2, 9, this->e1);
	elementCallback(2, 0, this->e1_e2);
	elementCallback(2, 14, (-1.0)*this->e1_e2_ni);
	elementCallback(2, 13, (-1.0)*this->e1_e2_no);
	elementCallback(2, 15, this->e1_e2_no_ni);
	elementCallback(2, 11, this->e1_ni);
	elementCallback(2, 10, this->e1_no);
	elementCallback(2, 12, this->e1_no_ni);
	...
	elementCallback(10, 0, this->e2_ni);
	elementCallback(10, 15, (-1.0)*this->e2_ni);
	elementCallback(10, 13, this->e2_no_ni);
	elementCallback(10, 12, this->ni);
	elementCallback(10, 9, (-1.0)*this->ni);
	elementCallback(10, 10, this->no_ni);
	elementCallback(10, 3, this->e1);
	elementCallback(10, 6, (-1.0)*this->e1_e2);
	elementCallback(10, 1, this->e1_e2_ni);
	elementCallback(10, 8, (-1.0)*this->e1_e2_ni);
	elementCallback(10, 6, (-1.0)*this->e1_e2_no_ni);
	elementCallback(10, 2, this->e1_ni);
	elementCallback(10, 5, (-1.0)*this->e1_ni);
	elementCallback(10, 3, this->e1_no_ni);
	elementCallback(10, 13, this->e2);
	elementCallback(11, 11, this->_1);
	elementCallback(11, 0, this->e2_no);
	elementCallback(11, 15, this->e2_no);
	elementCallback(11, 14, (-1.0)*this->e2_no_ni);
	elementCallback(11, 12, (-1.0)*this->no);
	elementCallback(11, 9, (-1.0)*this->no);
	elementCallback(11, 11, (-1.0)*this->no_ni);
	elementCallback(11, 4, this->e1);
	elementCallback(11, 7, (-1.0)*this->e1_e2);
	elementCallback(11, 1, this->e1_e2_no);
	elementCallback(11, 8, this->e1_e2_no);
	elementCallback(11, 7, this->e1_e2_no_ni);
	elementCallback(11, 2, this->e1_no);
	elementCallback(11, 5, this->e1_no);
	elementCallback(11, 4, (-1.0)*this->e1_no_ni);
	elementCallback(11, 14, this->e2);
	elementCallback(15, 15, (-1.0)*this->_1);
	elementCallback(15, 11, (-1.0)*this->e2_ni);
	elementCallback(15, 10, this->e2_no);
	elementCallback(15, 9, (-1.0)*this->e2_no_ni);
	elementCallback(15, 14, this->ni);
	elementCallback(15, 13, (-1.0)*this->no);
	elementCallback(15, 0, (-1.0)*this->no_ni);
	elementCallback(15, 8, (-1.0)*this->e1);
	elementCallback(15, 5, this->e1_e2);
	elementCallback(15, 4, (-1.0)*this->e1_e2_ni);
	elementCallback(15, 3, this->e1_e2_no);
	elementCallback(15, 2, this->e1_e2_no_ni);
	elementCallback(15, 7, (-1.0)*this->e1_ni);
	elementCallback(15, 6, this->e1_no);
	elementCallback(15, 1, (-1.0)*this->e1_no_ni);
	elementCallback(15, 12, (-1.0)*this->e2);
	elementCallback(3, 3, this->_1);
	elementCallback(3, 1, this->e2_ni);
	elementCallback(3, 8, (-1.0)*this->e2_ni);
	elementCallback(3, 6, (-1.0)*this->e2_no_ni);
	elementCallback(3, 2, this->ni);
	elementCallback(3, 5, (-1.0)*this->ni);
	elementCallback(3, 3, this->no_ni);
	elementCallback(3, 10, this->e1);
	elementCallback(3, 13, this->e1_e2);
	elementCallback(3, 0, this->e1_e2_ni);
	elementCallback(3, 15, (-1.0)*this->e1_e2_ni);
	elementCallback(3, 13, this->e1_e2_no_ni);
	elementCallback(3, 12, this->e1_ni);
	elementCallback(3, 9, (-1.0)*this->e1_ni);
	elementCallback(3, 10, this->e1_no_ni);
	elementCallback(3, 6, (-1.0)*this->e2);
	elementCallback(4, 4, this->_1);
	elementCallback(4, 1, this->e2_no);
	elementCallback(4, 8, this->e2_no);
	elementCallback(4, 7, this->e2_no_ni);
	elementCallback(4, 2, this->no);
	elementCallback(4, 5, this->no);
	elementCallback(4, 4, (-1.0)*this->no_ni);
	elementCallback(4, 11, this->e1);
	elementCallback(4, 14, this->e1_e2);
	elementCallback(4, 0, this->e1_e2_no);
	elementCallback(4, 15, this->e1_e2_no);
	elementCallback(4, 14, (-1.0)*this->e1_e2_no_ni);
	elementCallback(4, 12, (-1.0)*this->e1_no);
	elementCallback(4, 9, (-1.0)*this->e1_no);
	elementCallback(4, 11, (-1.0)*this->e1_no_ni);
	elementCallback(4, 7, (-1.0)*this->e2);
	elementCallback(8, 8, (-1.0)*this->_1);
	elementCallback(8, 4, (-1.0)*this->e2_ni);
	elementCallback(8, 3, this->e2_no);
	elementCallback(8, 2, this->e2_no_ni);
	elementCallback(8, 7, (-1.0)*this->ni);
	elementCallback(8, 6, this->no);
	elementCallback(8, 1, (-1.0)*this->no_ni);
	elementCallback(8, 15, (-1.0)*this->e1);
	elementCallback(8, 12, (-1.0)*this->e1_e2);
	elementCallback(8, 11, (-1.0)*this->e1_e2_ni);
	elementCallback(8, 10, this->e1_e2_no);
	elementCallback(8, 9, (-1.0)*this->e1_e2_no_ni);
	elementCallback(8, 14, this->e1_ni);
	elementCallback(8, 13, (-1.0)*this->e1_no);
	elementCallback(8, 0, (-1.0)*this->e1_no_ni);
	elementCallback(8, 5, this->e2);
	elementCallback(12, 12, (-1.0)*this->_1);
	elementCallback(12, 14, this->e2_ni);
	elementCallback(12, 13, (-1.0)*this->e2_no);
	elementCallback(12, 0, (-1.0)*this->e2_no_ni);
	elementCallback(12, 11, (-1.0)*this->ni);
	elementCallback(12, 10, this->no);
	elementCallback(12, 9, (-1.0)*this->no_ni);
	elementCallback(12, 5, (-1.0)*this->e1);
	elementCallback(12, 8, this->e1_e2);
	elementCallback(12, 7, this->e1_e2_ni);
	elementCallback(12, 6, (-1.0)*this->e1_e2_no);
	elementCallback(12, 1, this->e1_e2_no_ni);
	elementCallback(12, 4, this->e1_ni);
	elementCallback(12, 3, (-1.0)*this->e1_no);
	elementCallback(12, 2, (-1.0)*this->e1_no_ni);
	elementCallback(12, 15, (-1.0)*this->e2);
	elementCallback(5, 5, (-1.0)*this->_1);
	elementCallback(5, 7, this->e2_ni);
	elementCallback(5, 6, (-1.0)*this->e2_no);
	elementCallback(5, 1, this->e2_no_ni);
	elementCallback(5, 4, this->ni);
	elementCallback(5, 3, (-1.0)*this->no);
	elementCallback(5, 2, (-1.0)*this->no_ni);
	elementCallback(5, 12, (-1.0)*this->e1);
	elementCallback(5, 15, (-1.0)*this->e1_e2);
	elementCallback(5, 14, this->e1_e2_ni);
	elementCallback(5, 13, (-1.0)*this->e1_e2_no);
	elementCallback(5, 0, (-1.0)*this->e1_e2_no_ni);
	elementCallback(5, 11, (-1.0)*this->e1_ni);
	elementCallback(5, 10, this->e1_no);
	elementCallback(5, 9, (-1.0)*this->e1_no_ni);
	elementCallback(5, 8, this->e2);
}
