...
{
	psuedoscalar.e1_e2_no_ni = this->e1_e2_no_ni;
}
...
void Multivector::ToSquareMatrix(std::function<void(int, int, double)> elementCallback) const
{
	...
	elementCallback(0, 11, this->e2_ni);
	elementCallback(0, 10, this->e2_no);
	elementCallback(0, 12, this->e2_no_ni);
	elementCallback(0, 14, (-1.0)*this->ni);
	elementCallback(0, 13, (-1.0)*this->no);
	elementCallback(0, 15, this->no_ni);
	elementCallback(0, 1, this->e1);
	elementCallback(0, 2, (-1.0)*this->e1_e2);
	elementCallback(0, 4, this->e1_e2_ni);
	elementCallback(0, 3, this->e1_e2_no);
	elementCallback(0, 5, (-1.0)*this->e1_e2_no_ni);
	elementCallback(0, 7, this->e1_ni);
	elementCallback(0, 6, this->e1_no);
	elementCallback(0, 8, this->e1_no_ni);
	elementCallback(0, 9, this->e2);
	elementCallback(1, 1, this->_1);
	elementCallback(1, 4, this->e2_ni);
	elementCallback(1, 3, this->e2_no);
	elementCallback(1, 5, (-1.0)*this->e2_no_ni);
	elementCallback(1, 7, this->ni);
	elementCallback(1, 6, this->no);
	elementCallback(1, 8, this->no_ni);
	elementCallback(1, 0, this->e1);
	elementCallback(1, 9, this->e1_e2);
	elementCallback(1, 11, this->e1_e2_ni);
	elementCallback(1, 10, this->e1_e2_no);
	elementCallback(1, 12, this->e1_e2_no_ni);
	elementCallback(1, 14, (-1.0)*this->e1_ni);
	elementCallback(1, 13, (-1.0)*this->e1_no);
	elementCallback(1, 15, this->e1_no_ni);
	elementCallback(1, 2, (-1.0)*this->e2);
	elementCallback(2, 9, this->_1);
	elementCallback(2, 14, (-1.0)*this->e2_ni);
	elementCallback(2, 13, (-1.0)*this->e2_no);
	elementCallback(2, 15, this->e2_no_ni);
	elementCallback(2, 11, this->ni);
	elementCallback(2, 10, this->no);
	elementCallback(2, 12, this->no_ni);
	...
	elementCallback(2, 8, (-1.0)*this->e1_e2_no_ni);
	elementCallback(2, 4, (-1.0)*this->e1_ni);
	elementCallback(2, 3, (-1.0)*this->e1_no);
	elementCallback(2, 5, this->e1_no_ni);
	elementCallback(2, 0, this->e2);
	elementCallback(3, 13, this->_1);
	elementCallback(3, 12, this->e2_ni);
	elementCallback(3, 9, (-1.0)*this->e2_ni);
	elementCallback(3, 10, this->e2_no_ni);
	elementCallback(3, 0, this->ni);
	elementCallback(3, 15, (-1.0)*this->ni);
	elementCallback(3, 13, this->no_ni);
	elementCallback(3, 6, this->e1);
	elementCallback(3, 3, (-1.0)*this->e1_e2);
	elementCallback(3, 2, (-1.0)*this->e1_e2_ni);
	elementCallback(3, 5, this->e1_e2_ni);
	elementCallback(3, 3, (-1.0)*this->e1_e2_no_ni);
	elementCallback(3, 1, (-1.0)*this->e1_ni);
	elementCallback(3, 8, this->e1_ni);
	elementCallback(3, 6, this->e1_no_ni);
	elementCallback(3, 10, this->e2);
	elementCallback(4, 14, this->_1);
	elementCallback(4, 12, (-1.0)*this->e2_no);
	elementCallback(4, 9, (-1.0)*this->e2_no);
	elementCallback(4, 11, (-1.0)*this->e2_no_ni);
	elementCallback(4, 0, this->no);
	elementCallback(4, 15, this->no);
	elementCallback(4, 14, (-1.0)*this->no_ni);
	elementCallback(4, 7, this->e1);
	elementCallback(4, 4, (-1.0)*this->e1_e2);
	elementCallback(4, 2, (-1.0)*this->e1_e2_no);
	elementCallback(4, 5, (-1.0)*this->e1_e2_no);
	elementCallback(4, 4, this->e1_e2_no_ni);
	elementCallback(4, 1, (-1.0)*this->e1_no);
	elementCallback(4, 8, (-1.0)*this->e1_no);
	elementCallback(4, 7, (-1.0)*this->e1_no_ni);
	elementCallback(4, 11, this->e2);
	elementCallback(5, 2, this->_1);
	elementCallback(5, 7, (-1.0)*this->e2_ni);
	elementCallback(5, 6, (-1.0)*this->e2_no);
	elementCallback(5, 8, (-1.0)*this->e2_no_ni);
	elementCallback(5, 4, (-1.0)*this->ni);
	elementCallback(5, 3, (-1.0)*this->no);
	elementCallback(5, 5, this->no_ni);
	elementCallback(5, 9, this->e1);
	elementCallback(5, 0, this->e1_e2);
	elementCallback(5, 14, (-1.0)*this->e1_e2_ni);
	elementCallback(5, 13, (-1.0)*this->e1_e2_no);
	elementCallback(5, 15, this->e1_e2_no_ni);
	elementCallback(5, 11, this->e1_ni);
	elementCallback(5, 10, this->e1_no);
	elementCallback(5, 12, this->e1_no_ni);
	elementCallback(5, 1, (-1.0)*this->e2);
	elementCallback(6, 6, this->_1);
	elementCallback(6, 2, (-1.0)*this->e2_ni);
	elementCallback(6, 5, this->e2_ni);
	elementCallback(6, 3, (-1.0)*this->e2_no_ni);
	elementCallback(6, 1, (-1.0)*this->ni);
	elementCallback(6, 8, this->ni);
	elementCallback(6, 6, this->no_ni);
	elementCallback(6, 13, this->e1);
	elementCallback(6, 10, this->e1_e2);
	elementCallback(6, 12, this->e1_e2_ni);
	elementCallback(6, 9, (-1.0)*this->e1_e2_ni);
	elementCallback(6, 10, this->e1_e2_no_ni);
	elementCallback(6, 0, this->e1_ni);
	elementCallback(6, 15, (-1.0)*this->e1_ni);
	elementCallback(6, 13, this->e1_no_ni);
	elementCallback(6, 3, (-1.0)*this->e2);
	elementCallback(7, 7, this->_1);
	elementCallback(7, 2, (-1.0)*this->e2_no);
	elementCallback(7, 5, (-1.0)*this->e2_no);
	elementCallback(7, 4, this->e2_no_ni);
	elementCallback(7, 1, (-1.0)*this->no);
	elementCallback(7, 8, (-1.0)*this->no);
	elementCallback(7, 7, (-1.0)*this->no_ni);
	elementCallback(7, 14, this->e1);
	elementCallback(7, 11, this->e1_e2);
	elementCallback(7, 12, (-1.0)*this->e1_e2_no);
	elementCallback(7, 9, (-1.0)*this->e1_e2_no);
	elementCallback(7, 11, (-1.0)*this->e1_e2_no_ni);
	elementCallback(7, 0, this->e1_no);
	elementCallback(7, 15, this->e1_no);
	elementCallback(7, 14, (-1.0)*this->e1_no_ni);
	elementCallback(7, 4, (-1.0)*this->e2);
	elementCallback(8, 10, this->_1);
	elementCallback(8, 0, this->e2_ni);
	elementCallback(8, 15, (-1.0)*this->e2_ni);
	elementCallback(8, 13, this->e2_no_ni);
	elementCallback(8, 12, this->ni);
	elementCallback(8, 9, (-1.0)*this->ni);
	elementCallback(8, 10, this->no_ni);
	elementCallback(8, 3, this->e1);
	elementCallback(8, 6, (-1.0)*this->e1_e2);
	elementCallback(8, 1, this->e1_e2_ni);
	elementCallback(8, 8, (-1.0)*this->e1_e2_ni);
	elementCallback(8, 6, (-1.0)*this->e1_e2_no_ni);
	elementCallback(8, 2, this->e1_ni);
	elementCallback(8, 5, (-1.0)*this->e1_ni);
	elementCallback(8, 3, this->e1_no_ni);
	elementCallback(8, 13, this->e2);
	elementCallback(9, 11, this->_1);
	elementCallback(9, 0, this->e2_no);
	elementCallback(9, 15, this->e2_no);
	elementCallback(9, 14, (-1.0)*this->e2_no_ni);
	elementCallback(9, 12, (-1.0)*this->no);
	elementCallback(9, 9, (-1.0)*this->no);
	elementCallback(9, 11, (-1.0)*this->no_ni);
	elementCallback(9, 4, this->e1);
	elementCallback(9, 7, (-1.0)*this->e1_e2);
	elementCallback(9, 1, this->e1_e2_no);
	elementCallback(9, 8, this->e1_e2_no);
	elementCallback(9, 7, this->e1_e2_no_ni);
	elementCallback(9, 2, this->e1_no);
	elementCallback(9, 5, this->e1_no);
	elementCallback(9, 4, (-1.0)*this->e1_no_ni);
	elementCallback(9, 14, this->e2);
	elementCallback(10, 15, (-1.0)*this->_1);
	elementCallback(10, 11, (-1.0)*this->e2_ni);
	elementCallback(10, 10, this->e2_no);
	elementCallback(10, 9, (-1.0)*this->e2_no_ni);
	elementCallback(10, 14, this->ni);
	elementCallback(10, 13, (-1.0)*this->no);
	elementCallback(10, 0, (-1.0)*this->no_ni);
	elementCallback(10, 8, (-1.0)*this->e1);
	elementCallback(10, 5, this->e1_e2);
	elementCallback(10, 4, (-1.0)*this->e1_e2_ni);
	elementCallback(10, 3, this->e1_e2_no);
	elementCallback(10, 2, this->e1_e2_no_ni);
	elementCallback(10, 7, (-1.0)*this->e1_ni);
	elementCallback(10, 6, this->e1_no);
	elementCallback(10, 1, (-1.0)*this->e1_no_ni);
	elementCallback(10, 12, (-1.0)*this->e2);
	elementCallback(11, 3, this->_1);
	elementCallback(11, 1, this->e2_ni);
	elementCallback(11, 8, (-1.0)*this->e2_ni);
	elementCallback(11, 6, (-1.0)*this->e2_no_ni);
	elementCallback(11, 2, this->ni);
	elementCallback(11, 5, (-1.0)*this->ni);
	elementCallback(11, 3, this->no_ni);
	elementCallback(11, 10, this->e1);
	elementCallback(11, 13, this->e1_e2);
	elementCallback(11, 0, this->e1_e2_ni);
	elementCallback(11, 15, (-1.0)*this->e1_e2_ni);
	elementCallback(11, 13, this->e1_e2_no_ni);
	elementCallback(11, 12, this->e1_ni);
	elementCallback(11, 9, (-1.0)*this->e1_ni);
	elementCallback(11, 10, this->e1_no_ni);
	elementCallback(11, 6, (-1.0)*this->e2);
	elementCallback(12, 4, this->_1);
	elementCallback(12, 1, this->e2_no);
	elementCallback(12, 8, this->e2_no);
	elementCallback(12, 7, this->e2_no_ni);
	elementCallback(12, 2, this->no);
	elementCallback(12, 5, this->no);
	elementCallback(12, 4, (-1.0)*this->no_ni);
	elementCallback(12, 11, this->e1);
	elementCallback(12, 14, this->e1_e2);
	elementCallback(12, 0, this->e1_e2_no);
	elementCallback(12, 15, this->e1_e2_no);
	elementCallback(12, 14, (-1.0)*this->e1_e2_no_ni);
	elementCallback(12, 12, (-1.0)*this->e1_no);
	elementCallback(12, 9, (-1.0)*this->e1_no);
	elementCallback(12, 11, (-1.0)*this->e1_no_ni);
	elementCallback(12, 7, (-1.0)*this->e2);
	elementCallback(13, 8, (-1.0)*this->_1);
	elementCallback(13, 4, (-1.0)*this->e2_ni);
	elementCallback(13, 3, this->e2_no);
	elementCallback(13, 2, this->e2_no_ni);
	elementCallback(13, 7, (-1.0)*this->ni);
	elementCallback(13, 6, this->no);
	elementCallback(13, 1, (-1.0)*this->no_ni);
	elementCallback(13, 15, (-1.0)*this->e1);
	elementCallback(13, 12, (-1.0)*this->e1_e2);
	elementCallback(13, 11, (-1.0)*this->e1_e2_ni);
	elementCallback(13, 10, this->e1_e2_no);
	elementCallback(13, 9, (-1.0)*this->e1_e2_no_ni);
	elementCallback(13, 14, this->e1_ni);
	elementCallback(13, 13, (-1.0)*this->e1_no);
	elementCallback(13, 0, (-1.0)*this->e1_no_ni);
	elementCallback(13, 5, this->e2);
	elementCallback(14, 12, (-1.0)*this->_1);
	elementCallback(14, 14, this->e2_ni);
	elementCallback(14, 13, (-1.0)*this->e2_no);
	elementCallback(14, 0, (-1.0)*this->e2_no_ni);
	elementCallback(14, 11, (-1.0)*this->ni);
	elementCallback(14, 10, this->no);
	elementCallback(14, 9, (-1.0)*this->no_ni);
	elementCallback(14, 5, (-1.0)*this->e1);
	elementCallback(14, 8, this->e1_e2);
	elementCallback(14, 7, this->e1_e2_ni);
	elementCallback(14, 6, (-1.0)*this->e1_e2_no);
	elementCallback(14, 1, this->e1_e2_no_ni);
	elementCallback(14, 4, this->e1_ni);
	elementCallback(14, 3, (-1.0)*this->e1_no);
	elementCallback(14, 2, (-1.0)*this->e1_no_ni);
	elementCallback(14, 15, (-1.0)*this->e2);
	elementCallback(15, 5, (-1.0)*this->_1);
	elementCallback(15, 7, this->e2_ni);
	elementCallback(15, 6, (-1.0)*this->e2_no);
	elementCallback(15, 1, this->e2_no_ni);
	elementCallback(15, 4, this->ni);
	elementCallback(15, 3, (-1.0)*this->no);
	elementCallback(15, 2, (-1.0)*this->no_ni);
	elementCallback(15, 12, (-1.0)*this->e1);
	elementCallback(15, 15, (-1.0)*this->e1_e2);
	elementCallback(15, 14, this->e1_e2_ni);
	elementCallback(15, 13, (-1.0)*this->e1_e2_no);
	elementCallback(15, 0, (-1.0)*this->e1_e2_no_ni);
	elementCallback(15, 11, (-1.0)*this->e1_ni);
	elementCallback(15, 10, this->e1_no);
	elementCallback(15, 9, (-1.0)*this->e1_no_ni);
	elementCallback(15, 8, this->e2);
}
...
void Multivector::ToColumnMatrix(std::function<void(int, double)> elementCallback) const
{
	...
	elementCallback(3, this->e1_e2_ni);
	elementCallback(4, this->e1_e2_no);
	elementCallback(5, this->e1_e2_no_ni);
	elementCallback(6, this->e1_ni);
	elementCallback(7, this->e1_no);
	elementCallback(8, this->e1_no_ni);
	elementCallback(9, this->e2);
	elementCallback(10, this->e2_ni);
	elementCallback(11, this->e2_no);
	elementCallback(12, this->e2_no_ni);
	elementCallback(13, this->ni);
	elementCallback(14, this->no);
	elementCallback(15, this->no_ni);
}
